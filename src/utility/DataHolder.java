...
public abstract class DataHolder {
	...
	public static void createDummyShowList(){
		...
		Play show2 = new Play("Long Day's Journey Into Night");
		...
		Play show3 = new Play("Who's Afraid of Virginia Woolf?");
		...
		Play show4 = new Play("Death of a Salesman");
		...
		Play show5 = new Play("Oedipus Rex");
