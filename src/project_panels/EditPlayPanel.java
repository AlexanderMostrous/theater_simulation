...
public class EditPlayPanel extends JPanel implements ActionListener{
	...
	private JPanel getMainPanel()
	{
		...
		playTitleTxtFld = new JTextField(this.myPlay.getTitle());
		...
		gbc.anchor = GridBagConstraints.CENTER;
		gbc.insets = new Insets(5, 5, 5, 5);
		directorTxtFld = new JTextField(myPlay.getMyDetails().getDirector());
		...
		gbc.anchor = GridBagConstraints.CENTER;		
		gbc.insets = new Insets(5, 5, 5, 5);
		scriptWriterTxtFld = new JTextField(myPlay.getMyDetails().getScriptWriter());
